...
= 0.2.20 =
* Fix pt_BR admin UI staying in English on WordPress 6.7+ (load local .mo on init).
* Barbas Update hub 2.2.28 (hub candidate only; Connect remains free / no license tab).

= 0.2.19 =
* Connections table: restore Status column; badge centered in that column.
...
= 0.2.17 =
* Barbas Update hub 2.2.27: keep thickbox close (X); hide only duplicate title text.

= 0.2.16 =
* Header: version badge beside logo (single line).
* Connections: status beside label; shorter Pending; drop Status column.
* Hub 2.2.26: hide thickbox #TB_title.

= 0.2.15 =
* Admin UI polish: left-aligned header, lead line break, version next to copy, centered WSAL badge, connection ID inline.

= 0.2.14 =
* Restore Barbas Digital suite footer; tighten admin top padding.
