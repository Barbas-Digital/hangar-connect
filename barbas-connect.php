...
Description: Site agent for Barbas Console: secure REST API, pairing keys, and bridge stubs for Activity Reports. Updates via Settings -> Barbas Update.
Version: 0.1.2
...
define('BARBAS_CONNECT_VERSION', '0.1.2');
